...
public class InfectedScraplandianEntity extends Monster {
	...
	protected void registerGoals() {
		super.registerGoals();
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, ScraplandianEntity.class, true, false));
