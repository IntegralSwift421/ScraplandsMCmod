...
public class TopazWandEntity extends AbstractArrow implements ItemSupplier {
	...
	public TopazWandEntity(EntityType<? extends TopazWandEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public TopazWandEntity(EntityType<? extends TopazWandEntity> type, LivingEntity entity, Level world) {
