...
public class OrbonautEntity extends Monster implements RangedAttackMob {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("badlands"),
			new ResourceLocation("hard_to_find_biomes_by_fzprules:scraplands"), new ResourceLocation("end_midlands"), new ResourceLocation("desert"),
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(HardToFindBiomesByFzprulesModEntities.ORBONAUT.get(), 1, 1, 1));
	}
	...
	public OrbonautEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HardToFindBiomesByFzprulesModEntities.ORBONAUT.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(HardToFindBiomesByFzprulesModEntities.ORBONAUT.get(), SpawnPlacements.Type.ON_GROUND,
