	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				Random random = IceWispEntity.this.getRandom();
				double dir_x = IceWispEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = IceWispEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = IceWispEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
