...
public class FairycrystalWandEntity extends AbstractArrow implements ItemSupplier {
	...
	public FairycrystalWandEntity(EntityType<? extends FairycrystalWandEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public FairycrystalWandEntity(EntityType<? extends FairycrystalWandEntity> type, LivingEntity entity, Level world) {
