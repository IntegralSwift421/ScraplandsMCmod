...
public class ScraplandianMenuScreen extends AbstractContainerScreen<ScraplandianMenuMenu> {
	private final static HashMap<String, Object> guistate = ScraplandianMenuMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ScraplandianMenuScreen(ScraplandianMenuMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("scraplands_by_fzprules:textures/screens/scraplandian_menu.png");
