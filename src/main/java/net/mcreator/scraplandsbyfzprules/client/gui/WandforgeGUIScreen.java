...
public class WandforgeGUIScreen extends AbstractContainerScreen<WandforgeGUIMenu> {
	private final static HashMap<String, Object> guistate = WandforgeGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public WandforgeGUIScreen(WandforgeGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Wand Forge", 6, 7, -12829636);
	}
