...
public class ModelMushroom<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("hard_to_find_biomes_by_fzprules", "model_mushroom"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Mushroom = partdefinition
				.addOrReplaceChild(
						"Mushroom", CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-2.0F, -5.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.25F)),
