...
public class ModelFallingSpike<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("hard_to_find_biomes_by_fzprules", "model_falling_spike"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Block = partdefinition.addOrReplaceChild("Block",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -26.0F, -8.0F, 16.0F, 7.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 23)
