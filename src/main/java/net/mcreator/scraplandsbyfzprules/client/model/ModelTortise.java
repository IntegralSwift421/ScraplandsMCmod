...
public class ModelTortise<T extends Entity> extends EntityModel<T> {
	...
	public final ModelPart HindLeftLeg;
	public final ModelPart FrontRightLeg;
	public final ModelPart HindRightLeg;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition
				.addOrReplaceChild("Head",
						CubeListBuilder.create().texOffs(64, 6).addBox(-5.0F, -6.0F, -9.0F, 10.0F, 8.0F, 10.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-1.0F, -8.0F, -8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 19.0F, -7.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 32).addBox(-8.0F, -18.0F, -8.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition FrontLeftLeg = partdefinition.addOrReplaceChild("FrontLeftLeg",
				CubeListBuilder.create().texOffs(0, 64).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(9.0F, 19.5F, -5.0F));
		PartDefinition HindLeftLeg = partdefinition.addOrReplaceChild("HindLeftLeg",
				CubeListBuilder.create().texOffs(48, 64).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(9.0F, 19.5F, 5.0F));
		PartDefinition FrontRightLeg = partdefinition.addOrReplaceChild("FrontRightLeg",
				CubeListBuilder.create().texOffs(32, 64).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.0F, 19.5F, -5.0F));
		PartDefinition HindRightLeg = partdefinition.addOrReplaceChild("HindRightLeg",
				CubeListBuilder.create().texOffs(16, 64).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.0F, 19.5F, 5.0F));
		PartDefinition Tail = partdefinition
				.addOrReplaceChild(
						"Tail", CubeListBuilder.create().texOffs(48, 5).addBox(-3.0F, -2.0F, 0.0F, 6.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-1.0F, -4.0F, 2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
