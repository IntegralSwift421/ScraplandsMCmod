...
public class SnowlandFurryRenderer extends HumanoidMobRenderer<SnowlandFurryEntity, HumanoidModel<SnowlandFurryEntity>> {
	public SnowlandFurryRenderer(EntityRendererProvider.Context context) {
