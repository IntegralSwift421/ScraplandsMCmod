...
public class InfectedScraplandianRenderer extends HumanoidMobRenderer<InfectedScraplandianEntity, HumanoidModel<InfectedScraplandianEntity>> {
	public InfectedScraplandianRenderer(EntityRendererProvider.Context context) {
