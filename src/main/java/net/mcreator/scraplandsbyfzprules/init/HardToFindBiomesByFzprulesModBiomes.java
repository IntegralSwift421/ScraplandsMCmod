...
public class HardToFindBiomesByFzprulesModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, HardToFindBiomesByFzprulesMod.MODID);
					...
					if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
						...
						surfaceRules.add(1,
								preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, LIFELESS_SCRAPLANDS.getId()),
										HardToFindBiomesByFzprulesModBlocks.RUSTY_TOP.get().defaultBlockState(),
										HardToFindBiomesByFzprulesModBlocks.RUSTY_DIRT.get().defaultBlockState(), Blocks.CLAY.defaultBlockState()));
						surfaceRules.add(1,
								preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, SCRAPLANDS.getId()),
										...
										HardToFindBiomesByFzprulesModBlocks.SCRAP_PILE.get().defaultBlockState()));
