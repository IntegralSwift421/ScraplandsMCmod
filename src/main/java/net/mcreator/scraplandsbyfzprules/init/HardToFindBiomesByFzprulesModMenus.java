...
public class HardToFindBiomesByFzprulesModMenus {
	...
	public static final MenuType<WandforgeGUIMenu> WANDFORGE_GUI = register("wandforge_gui",
			(id, inv, extraData) -> new WandforgeGUIMenu(id, inv, extraData));
