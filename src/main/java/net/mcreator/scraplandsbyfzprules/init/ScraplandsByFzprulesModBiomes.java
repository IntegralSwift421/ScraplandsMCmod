...
public class ScraplandsByFzprulesModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, ScraplandsByFzprulesMod.MODID);
						...
						if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
							...
							surfaceRules.add(1,
									preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, SCRAPLANDS.getId()),
											...
											ScraplandsByFzprulesModBlocks.SCRAP_PILE.get().defaultBlockState()));
