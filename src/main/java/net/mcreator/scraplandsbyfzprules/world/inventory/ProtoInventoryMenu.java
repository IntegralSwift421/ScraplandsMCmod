...
package net.mcreator.scraplandsbyfzprules.world.inventory;
...
public class ProtoInventoryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ProtoInventoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HardToFindBiomesByFzprulesModMenus.PROTO_INVENTORY, id);
