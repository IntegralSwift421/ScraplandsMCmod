...
public class ScraplandianMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ScraplandianMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ScraplandsByFzprulesModMenus.SCRAPLANDIAN_MENU, id);
