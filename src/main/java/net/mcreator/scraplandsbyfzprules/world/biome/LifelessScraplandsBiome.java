...
public class LifelessScraplandsBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("battle_of_the_races_by_fzprules:tree_lifeless_scraplands",
						FeatureUtils.register("battle_of_the_races_by_fzprules:tree_lifeless_scraplands", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										BlockStateProvider.simple(BattleOfTheRacesByFzprulesModBlocks.ROBOTIC_LOG.get().defaultBlockState()),
										new StraightTrunkPlacer(7, 2, 0),
										BlockStateProvider.simple(BattleOfTheRacesByFzprulesModBlocks.SCRAP_SOLAR_PANEL.get().defaultBlockState()),
						...
						List.of(CountPlacement.of(3), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								...
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("battle_of_the_races_by_fzprules:grass_lifeless_scraplands", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("battle_of_the_races_by_fzprules:disk_gravel_lifeless_scraplands",
						FeatureUtils.register("battle_of_the_races_by_fzprules:disk_gravel_lifeless_scraplands", Feature.DISK,
		...
		mobSpawnInfo.addSpawn(MobCategory.MONSTER,
				new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.MECHA_SLIME.get(), 120, 1, 3));
		mobSpawnInfo.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.ION_SLIME.get(), 90, 1, 2));
		mobSpawnInfo.addSpawn(MobCategory.MONSTER,
				new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.ION_DRONE.get(), 100, 4, 4));
		mobSpawnInfo.addSpawn(MobCategory.CREATURE,
				new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.SCRAPLANDIAN.get(), 20, 3, 5));
		mobSpawnInfo.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.PROTOGEN.get(), 20, 3, 5));
		mobSpawnInfo.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.ORBONAUT.get(), 2, 1, 2));
		mobSpawnInfo.addSpawn(MobCategory.MONSTER,
				new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.INFECTED_PROTOGEN.get(), 100, 2, 4));
		mobSpawnInfo.addSpawn(MobCategory.MONSTER,
				new MobSpawnSettings.SpawnerData(BattleOfTheRacesByFzprulesModEntities.INFECTED_SCRAPLANDIAN.get(), 150, 2, 5));
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY,
						BuiltinRegistries.BIOME.getKey(BattleOfTheRacesByFzprulesModBiomes.LIFELESS_SCRAPLANDS.get())),
