...
public class ModelFairyArmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fairyarmor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftWing_r1 = Body
				.addOrReplaceChild("LeftWing_r1",
						CubeListBuilder.create().texOffs(23, 32).addBox(1.0F, 0.0F, 0.0F, 9.0F, 11.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition RightWing_r1 = Body
				.addOrReplaceChild("RightWing_r1",
						CubeListBuilder.create().texOffs(0, 32).addBox(-10.0F, 0.0F, 0.0F, 9.0F, 11.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, 0.0F, 0.1745F, 0.0F));
