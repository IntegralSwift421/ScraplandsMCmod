	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -8.0F, -9.0F, 8.0F, 8.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(42, 5)
		...
		PartDefinition Ear_R_r1 = Head.addOrReplaceChild("Ear_R_r1",
				CubeListBuilder.create().texOffs(29, 0).addBox(-2.5F, -13.0F, -1.0F, 5.0F, 7.0F, 2.0F,
		...
		PartDefinition BodyLayer_r1 = Body.addOrReplaceChild("BodyLayer_r1",
				CubeListBuilder.create().texOffs(16, 38)
						.addBox(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(16, 22)
